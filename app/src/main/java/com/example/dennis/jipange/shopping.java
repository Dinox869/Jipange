...
public class shopping extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Name = (EditText)findViewById(R.id.shopping1);
        Price = (EditText)findViewById(R.id.shopping2);
        ...
        Save = (Button)findViewById(R.id.shopping3);
        Save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(Name.length()!= 0 && Price.length() > 0)
                {
                    ...
                    c.setname(NAME);
                    c.setprice(PRICE);
                    mdatabasehelper.insertsavingsshopping(c);
                    String History_food ;
                    String Field = "Shopping";
                    History_food = "Shopping: "+NAME+".";
                    ...
                    Name.setText("");
                    Price.setText("");
                    Toast.makeText(shopping.this, "Data stored", Toast.LENGTH_SHORT).show();
                }
                else
                {
                    Toast.makeText(shopping.this, "Kindly fill the details", Toast.LENGTH_SHORT).show();
                }
            }
        });
