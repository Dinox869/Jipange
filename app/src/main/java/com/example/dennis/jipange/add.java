...
public class add extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Price = (EditText)findViewById(R.id.add1);
        ...
        Save = (Button)findViewById(R.id.add3);
        Save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(Name.length()!=0 && Price.length() > 0)
                {
                    ...
                    c.setname(NAME);
                    c.setprice(PRICE);
                    mdatabasehelper.insertsavingadd(c);
                    String History_food ;
                    String Field = "Others";
                    History_food = "Other Items: "+NAME+".";
                    ...
                    Name.setText(" ");
                    Price.setText(" ");
                    Toast.makeText(add.this, "Data Stored", Toast.LENGTH_SHORT).show();
                }
                else
                {
                    Toast.makeText(add.this, "Kindly fill all the details", Toast.LENGTH_SHORT).show();
                }
            }
        });
}
