...
public class electronics extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Name = (EditText)findViewById(R.id.elec);
        Price = (EditText)findViewById(R.id.elec2);
        ...
        Save = (Button)findViewById(R.id.elec3);
        Save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(Name.length()!= 0 && Price.length() > 0)
                {
                    ...
                    c.setname(NAME);
                    c.setprice(PRICE);
                    mdatabasehelper.insertsavingelec(c);
                    String History_food ;
                    String Field = "Electronics";
                    History_food = "Electronic : "+NAME+".";
                    ...
                    Name.setText("");
                    Price.setText("");
                    Toast.makeText(electronics.this, "Data stored", Toast.LENGTH_SHORT).show();
                }
                else
                    {
                        Toast.makeText(electronics.this, "Kindly fill all the details", Toast.LENGTH_SHORT).show();
                    }
            }
        });
}
