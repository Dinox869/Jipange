...
public class drinkgraph extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            HamButton.Builder builder = new HamButton.Builder()
                    ...
                    .listener(new OnBMClickListener() {
                        ...
                        public void onBoomButtonClick(int index) {
                            ...
                            {
                                finish();
                                Intent intent = new Intent(drinkgraph.this, graph.class);
                                drinkgraph.this.startActivity(intent);
                            }
                            if ( index == 1)
                            {
                                finish();
                                Intent intent = new Intent(drinkgraph.this, foodgraph.class);
                                drinkgraph.this.startActivity(intent);
                            }
                            if ( index == 2)
                            {
                            ...
                            {
                                finish();
                                Intent intent = new Intent(drinkgraph.this, allgraph.class);
                                drinkgraph.this.startActivity(intent);
                            }
                        }
                    });
        ...
        xAxis.setValueFormatter(new drinkgraph.MyXaxisnamings(categories));
